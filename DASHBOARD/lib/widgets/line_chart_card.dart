...
class _LineChartCardState extends State<LineChartCard> {
  ...
  Widget build(BuildContext context) {
    final data = LineData();
    final MortgageController controller = Get.find();
                ...
                LineChartData(
                  ...
                  titlesData: FlTitlesData(
                    ...
                    leftTitles: AxisTitles(
                      sideTitles: SideTitles(
                        getTitlesWidget: (double value, TitleMeta meta) {
                          return data.leftTitle[value.toInt()] != null ? Text(data.leftTitle[value.toInt()].toString(), style: TextStyle(fontSize: 12, color: Colors.grey[400])) : const SizedBox();
                        },
                        showTitles: true,
                        interval: 1,
                        reservedSize: 40,
